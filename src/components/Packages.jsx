...
const Packages = () => {
  return (
    <div className="w-screen relative left-1/2 right-1/2 -mx-[50vw] bg-red-200" style={{ paddingTop: "200px" }}>
       ...
       <div
        className="max-w-xs mx-auto rounded-t-3xl overflow-hidden shadow-lg bg-[#F3C623] p-6 font-sans relative z-10
                    bg-no-repeat bg-[right_1rem_bottom]  bg-[length:200px]"
        style={{ backgroundImage: "url('/cat1R.png')" }}
        >
        <div className="mb-4">
        ...
        <div className="mb-6 relative">
            ...
            <ul className="space-y-2 text-white">
                ...
                <svg className="w-4 h-4 mr-2 text-white" fill="none" stroke="currentColor"
